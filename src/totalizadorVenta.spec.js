...
describe("Totalizador ventas", () => {
    ...
    it("Debería retornar un costo de envio por unidad igual a 6$, probando con un valor de peso volumetrico igual a 55", () => {
        expect(obtenerCostoDeEnvioPorUnidad(55)).toEqual(6);
    });
